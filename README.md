...
2. **Check the screen** — enter the headcount and how many rounds you want on the
   Pairings slide, and it builds them all. Everyone reads their partner off the table.
...
minute. Rounds are capped at one less than the headcount, and where a repeat cannot
be avoided — small odd groups pushed to several rounds — the page says so rather
