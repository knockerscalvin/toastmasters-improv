...
1. **Round One** — Pick a paper, find the person with the same number.
2. **Round Two** — +1 to your number, find the person with that number.
3. **Round Three** — +2 to your number, find the person with that number.
